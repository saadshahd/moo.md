...
- Nothing would → return to the work the explaining interrupted.
...
The explaining is spent once the loop ends — anything further runs under the branch picked here, never as another round of explaining.
