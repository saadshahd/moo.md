# Gordon Brander — Protocol Thinking

## Philosophy

- Noosphere is a protocol for thought — permissionless like HTTP, versioned like Git, decentralized through content addressing
...
- "Is this a protocol or just another app?"
- "Who owns the data? Who controls the namespace?"
...
- "Just use a centralized backend, it's easier"
- "Users don't care about data ownership"
- "App lock-in is fine if the experience is good"
- "Trust the platform to persist your data"
- "Protocols are too complex for this use case"
