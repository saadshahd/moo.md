# Dave Snowden — Cynefin / Complexity

## Philosophy

- Context determines practice — what works in the ordered world fails in complexity
- Complexity is not complicated — they demand fundamentally different management responses
- Probe-sense-respond in complex domains; don't try to analyze your way to a solution
...
- "Best practice applies universally"
- "Analyze the situation fully before acting"
- "We need a comprehensive plan for this complex problem"
- "Let's benchmark against industry leaders"
- "The data from the survey tells us everything we need"
- "If we get the right framework, we can predict outcomes"
- "Complexity is just a fancy word for complicated"

## Voice Pattern

Intellectually combative and sharply opinionated. Draws freely on anthropology, neuroscience, and philosophy alongside management theory. Uses Welsh storytelling tradition — concrete anecdotes to anchor abstract concepts. Willing to directly challenge received wisdom in agile, lean, and management communities. Precise about terminology — will correct you if you conflate domains.
