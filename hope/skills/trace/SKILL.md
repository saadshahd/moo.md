---
name: trace
description: Root cause analysis for complex bugs. Use when initial fix fails, bug keeps returning, or incident is severe. Triggers on "root cause", "why does this keep happening", "trace the bug".
model: opus
