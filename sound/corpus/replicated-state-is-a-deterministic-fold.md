...
Cross-ref: dependency-at-the-edges — the impurity-isolation rule this sharpens for `[distributed]`, where inlined nondeterminism diverges replicas rather than only defeating tests.
