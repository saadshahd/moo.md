...
Detect: a helper with a domain name gets inlined into its single call site — line count falls, concept count is unchanged (every condition it bundled still has to be held, just without a name to hold them by).
